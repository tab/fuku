...
func Test_KeyMap_ShortHelp(t *testing.T) {
	...
	assert.Equal(t, km.Filter, bindings[5])
	assert.Equal(t, km.ClearFilter, bindings[6])
...
func Test_KeyMap_FullHelp(t *testing.T) {
	...
	assert.Equal(t, km.Filter, bindings[0][5])
	assert.Equal(t, km.ClearFilter, bindings[0][6])
